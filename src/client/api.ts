...
export function localizedResponseError(body: unknown, status: number, fallbackKey = "errors.request"): string {
  ...
  if (code) {
    const key = ({
      ...
      GITHUB_ACCOUNT_INVALID: "errors.codes.GITHUB_ACCOUNT_INVALID",
      GITHUB_EMAIL_REQUIRED: "auth.githubEmailRequired",
      ...
      INVITATION_EMAIL_INVALID: "projectSettings.inviteEmailInvalid",
